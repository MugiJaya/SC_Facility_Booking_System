...
<html>
<head>
  <title>Admin / Customer Approval</title>
...
<div class="sidenav">
  ...
  <div class="dropdown-container">
    ...
    <a class="active" href="admin_customer_approval.php">Account Approval</a>
  </div>
  <!-- ------------------ Company ------------------ -->
...
<table id="table1">
  ...
  <form method="post" action="admin_process.php" enctype="multipart/form-data">
    ...
    <tr>
      <td colspan="4">
        <?php if ($update == true): ?>
        <button class="btn" type="submit" name="update2" >Update</button>
        <?php else: ?>
        <p></p>
        <?php endif ?>
      </td>  
