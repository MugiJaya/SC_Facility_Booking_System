...
<div>
  ...
  <div class="update-profile">
    ...
    <?php
    $update ="select * from customer WHERE email = '$session_id'";
    ...
    <form method="post" action="customer_process.php" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="inputBox">
            ...
            <input type="text" name="customer_name" value="<?php echo $fetch['customer_name']; ?>" class="box">
            <span>Email :</span>
