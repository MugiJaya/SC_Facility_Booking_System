		...
		<form id="border" class="border shadow p-3 rounded" style="width: 450px;">
			...
			<br>
		  	<div class="col-md-12 text-center">
		  		<a class="btn btn-primary" style="padding: 10px;" href="reset_password_cus.php";>👨‍💼 Customer</a>
		  		&nbsp;&nbsp;&nbsp;&nbsp;
		  		<a class="btn btn-primary" style="padding: 10px;" href="reset_password_com.php";>🏢 Company</a>
		  	</div>
