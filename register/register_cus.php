<?php include ('register_cus_process.php') ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
...
<body>
	<div class="container d-flex justify-content-center align-items-center" style="min-height: 100vh">
		<form id="border" class="border shadow p-3 rounded" action="register_cus_process.php" method="post" style="width: 450px;" enctype="multipart/form-data">
